...
int main(int argc, char *argv[])
{
    ...
    a45.SetBase("10.1.4.0", "255.255.255.0");
    a56.SetBase("10.1.5.0", "255.255.255.0");
    ...
    uint32_t extraNodeIcon = anim.AddResource("ns-allinone-3.42/ns-3.42/icon/user.png");  // ไอคอนสำหรับโหนด user ใหม่
    ...
    anim.UpdateNodeImage(nodes.Get(3)->GetId(), node2Icon);  // กำหนด icon ให้กับโหนดที่ 3
    ...
    ns3::AnimationInterface::SetConstantPosition(nodes.Get(0), 60, 20);
    ns3::AnimationInterface::SetConstantPosition(nodes.Get(1), 50, 45);
    ns3::AnimationInterface::SetConstantPosition(nodes.Get(2), 80, 45);
    ns3::AnimationInterface::SetConstantPosition(nodes.Get(3), 100, 45);  // วางตำแหน่งของโหนดที่ 3
